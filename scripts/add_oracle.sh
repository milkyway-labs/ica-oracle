...
echo ">>> strided tx icaoracle instantiate-oracle OSMO $code_id channel-0"
tx_hash=$($STRIDED tx icaoracle instantiate-oracle OSMO $code_id channel-0 --from admin -y | grep -E "txhash:" | awk '{print $2}') 
